                ...
                <table class="table table-striped">
                    ...
                    <tbody class="product_list">
                        ...
                        <tr data-id="{{ $item->productSku->id }}">
                            ...
                            <td>
                                <input type="text" class="form-control form-control-sm amount" @if(!$item->productSku->product->on_sale) disable @endif name="amount" value="{{ $item->amount }}">
                            </td>
                            <td>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-remove').click(function() {
            ...
            // closest() 方法可以获取到匹配选择器的第一个祖先元素，在这里是当前点击的 移除 按钮之上的 <tr> 标签
